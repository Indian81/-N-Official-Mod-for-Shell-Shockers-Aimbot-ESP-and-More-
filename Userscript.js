...
<div id="libertyMutualGui" style="font-family: 'Agency FB', sans-serif; padding: 14px; border: 2px solid red; border-radius: 5px; position: fixed; top: 20px; left: 20px; z-index: 9999;">
    <div>
      <h3 style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-style: italic; font-weight: bold; text-align: center;">Settings</h3>
        ...
        <!-- Aimbot Settings -->
      <h3 style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-style: italic; font-weight: bold; text-align: left;">Aimbot Settings</h3>
        ...
        <div>
      <h3 style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-style: italic; font-weight: bold; text-align: left;">Links</h3>
        <div>
...
function updateESPLineColor() {
    for (let i = 0; i < ESPArray.length; i++) {
        ...
        if (tracers) {
            tracers.color.r = espLineColor.r / 255;//RED
            tracers.color.g = espLineColor.g / 255;//BLUE
            tracers.color.b = espLineColor.b / 255;//GREEN
        }
    }
}
...
//Event Listener for Tracers Bind
...
//Event Listener for Aimbot Bind
